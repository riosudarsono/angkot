...
public class Terminal_Square extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener, DirectionCallback {
    ...
    private LatLng camera = new LatLng(-6.223452, 107.011492);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googleServiceAvailable()) {
            ...
            setContentView(R.layout.activity_terminal__square);
            initMap();
        } else {
            Toast.makeText(this, "Gagal", Toast.LENGTH_LONG).show();
            //Tidak ada google maps layout
        }
        mTextMessage = (TextView) findViewById(R.id.message_terminal_square);

        btn1 = (Button) findViewById(R.id.btn1_terminal_square);
        btn1.setOnClickListener(this);

        btn2 = (Button) findViewById(R.id.btn2_terminal_square);
        btn2.setOnClickListener(this);

        btn3 = (Button) findViewById(R.id.btn3_terminal_square);
    ...
    private void initMap() {
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapfragment_terminal_square);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn1_terminal_square) {
            mTextMessage.setText("BSI Square - POM Bensin Permata \nRp 3.000");
            requestDirection1();
        }
        else if (id == R.id.btn2_terminal_square){
            requestDirection2();
            mTextMessage.setText("POM Bensin Permata - UNISMA \nRp 10.000");
        }
        else if (id == R.id.btn3_terminal_square){
            requestDirection3();

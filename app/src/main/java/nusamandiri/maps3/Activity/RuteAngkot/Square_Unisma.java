...
public class Square_Unisma extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener, DirectionCallback {
    private Button btn1;
    private Button btn2;
    private Button btn3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googleServiceAvailable()) {
            ...
            setContentView(R.layout.activity_square__unisma);
            initMap();
        } else {
            Toast.makeText(this, "Gagal", Toast.LENGTH_LONG).show();
            //Tidak ada google maps layout
        }
        mTextMessage = (TextView) findViewById(R.id.message_square_unisma);

        btn1 = (Button) findViewById(R.id.btn1_square_unisma);
        btn1.setOnClickListener(this);

        btn2 = (Button) findViewById(R.id.btn2_square_unisma);
        btn2.setOnClickListener(this);

        btn3 = (Button) findViewById(R.id.btn3_square_unisma);
    ...
    private void initMap() {
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapfragment_square_unisma);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng kampus2 = new LatLng(-6.257433, 107.007225);
        mGoogleMap.addMarker(new MarkerOptions()
                .position(kampus2)
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn1_square_unisma) {
            mTextMessage.setText("BSI Square - POM Bensin Permata \nRp 3.000");
            requestDirection1();
        }
        else if (id == R.id.btn2_square_unisma){
            requestDirection2();
            mTextMessage.setText("POM Bensin Permata - UNISMA \nRp 9.000");
        }
        else if (id == R.id.btn3_square_unisma){
            requestDirection3();

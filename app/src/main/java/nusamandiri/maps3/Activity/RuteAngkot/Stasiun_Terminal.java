...
public class Stasiun_Terminal extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener, DirectionCallback {
    ...
    private LatLng camera = new LatLng(-6.243979, 107.006244);



    private LatLng origin2 = new LatLng(-6.2492676,107.0138091);//depan Terminal1
    private LatLng destination2 = new LatLng(-6.236061, 107.000387);//depan stasiun
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googleServiceAvailable()) {
            ...
            setContentView(R.layout.activity_stasiun__terminal);
            initMap();
        } else {
            Toast.makeText(this, "Gagal", Toast.LENGTH_LONG).show();
            //Tidak ada google maps layout
        }
        mTextMessage = (TextView) findViewById(R.id.message_stasiun_terminal);


        btn2 = (Button) findViewById(R.id.btn2_stasiun_terminal);
    ...
    private void initMap() {
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapfragment_stasiun_terminal);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng kampus1 = new LatLng(-6.249385, 107.013412);
        ...
        LatLng kampus2 = new LatLng(-6.236159, 106.999399);
        mGoogleMap.addMarker(new MarkerOptions()
                .position(kampus2)

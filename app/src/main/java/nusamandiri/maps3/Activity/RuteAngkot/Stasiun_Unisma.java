...
public class Stasiun_Unisma extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener, DirectionCallback {
    ...
    private LatLng camera = new LatLng(-6.244762, 107.008178);

    private LatLng origin1 = new LatLng(-6.236083, 107.000366);//depan stasiun
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextMessage = (TextView) findViewById(R.id.message_stasiun_unisma);



        btn2 = (Button) findViewById(R.id.btn2_stasiun_unisma);
    ...
    private void initMap() {
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapfragment_stasiun_unisma);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn2_stasiun_unisma){
            requestDirection2();

...
public class Ubhara_Unisma extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener, DirectionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googleServiceAvailable()) {
            ...
            setContentView(R.layout.activity_ubhara__unisma);
            initMap();
        } else {
            Toast.makeText(this, "Gagal", Toast.LENGTH_LONG).show();
            //Tidak ada google maps layout
        }
        mTextMessage = (TextView) findViewById(R.id.message_ubhara_unisma);


        btn1 = (Button) findViewById(R.id.btn1_ubhara_unisma);
        btn1.setOnClickListener(this);

        btn2 = (Button) findViewById(R.id.btn2_ubhara_unisma);
        btn2.setOnClickListener(this);

        btn3 = (Button) findViewById(R.id.btn3_ubhara_unisma);
    ...
    private void initMap() {
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapfragment_ubhara_unisma);
